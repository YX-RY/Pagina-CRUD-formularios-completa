    ...
    <form action="{{ route('students.store') }}" method="POST" enctype="multipart/form-data" id="studentForm">
        ...
        <div class="row">
            <div class="col-md-4 text-center mb-3">
                ...
                <div class="mb-2">
                    <img id="photoPreview" src="{{ asset('images/default-avatar.png') }}" class="rounded-circle border" width="150" height="150" alt="Foto Preview">
                </div>
            ...
            <div class="col-md-8">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="career" class="form-control" value="{{ old('career') }}" required>
                    </div>
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" name="enrollment_year" class="form-control" value="{{ old('enrollment_year') }}" required>
                    </div>
                </div>
